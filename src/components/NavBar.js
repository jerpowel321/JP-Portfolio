          ...
          <Grid item xs={6}>
            <Grid container justify="flex-end" >
              ...
              <Grid item style={{ paddingBottom: "20px", color: white, paddingTop: "20px" }}>
                ...
                <a href="https://www.dropbox.com/s/jv0f7sp6eqj13v4/JP_Resume.pdf?dl=0" target="_blank" rel="noopener noreferrer"><i className="fas fa-file-pdf fa-2x ml hvr-grow nml" style={{ color: white, paddingRight: "12px" }}></i></a>
              </Grid>
            </Grid>
            <Grid container justify="flex-end" >
